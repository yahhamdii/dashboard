import type { BoxProps } from 'src/types/component-props';
...
export function ProfileCover({
    ...
    <div className="flex flex-col md:flex-row left-0 md:left-6 bottom-0 md:bottom-6 z-0 md:z-10 pt-6 md:pt-0 relative md:absolute">
      <AvatarWrapper
        ...
        sx={{
          ...
          width: { xs: 64, md: 128 },
          height: { xs: 64, md: 128 },
          border: `solid 2px ${tokens.colors.common.white}`,
        }}
      >
  ...
  return (
    <Box
      sx={[
        {
          backgroundImage: `linear-gradient(0deg, ${varAlpha(tokens.colors.primary.darkerChannel, 0.8)}, ${varAlpha(tokens.colors.primary.darkerChannel, 0.8)}), url(${coverUrl})`,
